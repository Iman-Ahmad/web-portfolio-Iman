        ...
        <html lang="en">
            ...
            <body>
                <div style="position: relative;">
                    ...
                    <button class="btn btn-secondary" style="position: absolute; left: 20px; width: 100%;"><a href="https://Iman-Ahmad.github.io/web-portfolio-Iman/" style = "text-decoration: none;">Вернуться на главную страницу</a></button>
                </div>
                <xsl:apply-templates />
            </body>
        </html>
